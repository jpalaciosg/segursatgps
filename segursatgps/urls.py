...
urlpatterns = [
    ...
    path('reports/target-telemetry-report/', reports_views.target_telemetry_report_view, name='target-telemetry-report'),
    ...
    path('web/api/reports/get-detailed-report2/<int:id>/<str:initial_datetime>/<str:final_datetime>/', reports_views.get_detailed_report2),

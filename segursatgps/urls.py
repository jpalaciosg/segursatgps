...
urlpatterns = [
    ...
    path('web/api/reports/get-detailed-report/', reports_views.get_detailed_report),
    ...
    path('web/api/reports/get-driving-style-report/', reports_views.get_driving_style_report),

...
urlpatterns = [
    ...
    path('web/api/get-driver/<int:id>/', drivers_views.get_driver),
    path('web/api/get-geofences/', geofences_views.get_geofences),
    path('web/api/get-geofence/<str:name>/', geofences_views.get_geofence),
]
